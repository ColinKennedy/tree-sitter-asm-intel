...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 1:
      ...
      if (('2' <= lookahead && lookahead <= '7')) ADVANCE(173);
    ...
    case 29:
      ...
      if (('2' <= lookahead && lookahead <= '7')) ADVANCE(37);
      if (lookahead == '8' ||
          lookahead == '9' ||
          ('A' <= lookahead && lookahead <= 'F') ||
    ...
    case 170:
      ...
      if (lookahead == '8' ||
          lookahead == '9') ADVANCE(177);
      if (('2' <= lookahead && lookahead <= '7')) ADVANCE(176);
      if (('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(208);
      if (lookahead == '$' ||
          lookahead == '(' ||
