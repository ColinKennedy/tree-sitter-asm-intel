...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__constant, 1),
  [104] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__constant, 1),
  ...
  [114] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__deregister_repeat1, 2), SHIFT_REPEAT(71),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__deregister_repeat1, 2),
  [119] = {.entry = {.count = 1, .reusable = false}}, SHIFT(32),
  [121] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__gcc_pseudo_op, 3),
  ...
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__gcc_pseudo_op, 2),
  [137] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__gcc_pseudo_op, 2),
  ...
  [147] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pointer, 2),
  [149] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pointer, 2),
  [151] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_hexadecimal, 1),
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__deregister, 3),
  [155] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__deregister, 3),
  [157] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__normal_instruction, 3),
  [159] = {.entry = {.count = 1, .reusable = false}}, SHIFT(4),
  [161] = {.entry = {.count = 1, .reusable = false}}, SHIFT(5),
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__deregister, 5),
  [165] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__deregister, 5),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pointer, 1),
  [169] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pointer, 1),
  ...
  [211] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(15),
  [214] = {.entry = {.count = 1, .reusable = true}}, SHIFT(74),
  [216] = {.entry = {.count = 1, .reusable = true}}, SHIFT(73),
  [218] = {.entry = {.count = 1, .reusable = true}}, SHIFT(69),
  [220] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pointer_width, 2),
  [222] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_instruction, 1),
